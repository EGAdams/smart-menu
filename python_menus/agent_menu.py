...
def main():
    ...
    print("     a. Open the Autogen Agent 99 workspace\n")
    ...
    if choice == "a":
        print( "opening the Agent 99 project... " )
        os.system( "sleep 1" )
        os.system( "'/mnt/c/Users/EG/AppData/Local/Programs/Microsoft VS Code/bin/code' /home/adamsl/agent_99/autogen" )
        main()
    ...
    if choice == "t":
        os.system(
            "python3 /home/adamsl/linuxBash/OpenAI_Agent_Swarm/tool_creator_exec.py")
        input("Press Enter to continue...")
        main()
    ...
    if choice == "u":
        os.system(
            "python3 /home/adamsl/linuxBash/OpenAI_Agent_Swarm/tool_user_exec.py")
        input("Press Enter to continue...")
        main()
    ...
    if choice == "4":
        ...
        os.system("clear")
        os.system(
            "python3 /home/adamsl/linuxBash/python_menus/mcba_system_dashboard.py ")
        main()
